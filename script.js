...
// Detect if the webpage is being viewed on mobile or desktop
const isMobile = window.matchMedia("(max-width: 767px)").matches;

if (isMobile) {
  // Change orientation for mobile
  orientator.setAttribute('aria-pressed', true);
} else {
  // Change orientation for desktop
  orientator.setAttribute('aria-pressed', false);
}
